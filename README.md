...
* [Multidimensional-state Stochastic Optimal Growth Model from Santos (1999) Section 7.3](http://nbviewer.jupyter.org/github/QuantEcon/ContinuousDPs.jl/blob/main/examples/cdp_ex_optgrowth_multidim_jl.ipynb)
